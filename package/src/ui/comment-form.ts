...
import { addCreateCommentFormListener, removeCreateCommentFormListener } from "../lib/globals";
...
async function handleButtonClick(e: PointerEvent, input: HTMLTextAreaElement, cordinates: Cordinates, parent: HTMLDivElement) {
  e.preventDefault()
  ...
  await fetch("http://localhost:3001/api/comments/create", {
    ...
    body: JSON.stringify({
      description: comment,
      x_cordinate: cordinates.x,
      y_cordinate: cordinates.y,
