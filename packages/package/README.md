...
<html>
<head>
  <link rel="stylesheet" href="https://cdn.example.com/opencomments.css">
</head>
<body>
  <!-- Your content -->
...
function OpenCommentsWidget() {
  useEffect(() => {
    ...
    if (!document.querySelector('link[href*="opencomments.css"]')) {
      ...
      link.rel = 'stylesheet';
      link.href = 'https://cdn.example.com/opencomments.css';
    ...
    script.src = 'https://cdn.example.com/opencomments.js';
    script.async = true;
...
function App() {
  ...
  return (
    <div>
      ...
      <Script
        src="https://cdn.example.com/opencomments.js"
